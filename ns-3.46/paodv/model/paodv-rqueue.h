 ...
 */
#ifndef PAODV_RQUEUE_H
#define PAODV_RQUEUE_H
...
/**
 * @ingroup paodv
 * @brief PAODV route request queue
 *
 * Since PAODV is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
  public:
