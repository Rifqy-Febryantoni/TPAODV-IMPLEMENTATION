 ...
 */
#ifndef PAODVPACKET_H
#define PAODVPACKET_H
...
enum MessageType
{
    PAODVTYPE_RREQ = 1,    //!< PAODVTYPE_RREQ
    PAODVTYPE_RREP = 2,    //!< PAODVTYPE_RREP
    PAODVTYPE_RERR = 3,    //!< PAODVTYPE_RERR
    PAODVTYPE_RREP_ACK = 4 //!< PAODVTYPE_RREP_ACK
};
...
class TypeHeader : public Header
{
  public:
    /**
     * constructor
     * @param t the PAODV RREQ type
     */
    TypeHeader(MessageType t = PAODVTYPE_RREQ);
