...
{
    static TypeId tid = TypeId("ns3::paodv::TypeHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
{
    static TypeId tid = TypeId("ns3::paodv::RreqHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
{
    static TypeId tid = TypeId("ns3::paodv::RrepHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
{
    static TypeId tid = TypeId("ns3::paodv::RrepAckHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
{
    static TypeId tid = TypeId("ns3::paodv::RerrHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
