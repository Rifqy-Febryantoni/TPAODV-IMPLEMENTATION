 ...
 */
#include "ns3/tpaodv-neighbor.h"
#include "ns3/tpaodv-packet.h"
#include "ns3/tpaodv-rqueue.h"
#include "ns3/tpaodv-rtable.h"
...
{
    TypeHeaderTest()
        : TestCase("TPAODV TypeHeader")
    {
    }

    void DoRun() override
    {
        TypeHeader h(TPAODVTYPE_RREQ);
        NS_TEST_EXPECT_MSG_EQ(h.IsValid(), true, "Default header is valid");
        NS_TEST_EXPECT_MSG_EQ(h.Get(), TPAODVTYPE_RREQ, "Default header is RREQ");

        Ptr<Packet> p = Create<Packet>();
        p->AddHeader(h);
        TypeHeader h2(TPAODVTYPE_RREP);
 ...
 * @ingroup tpaodv-test
 *
 * @brief Unit test for TPAODV routing table entry
 */
 ...
 * @ingroup tpaodv-test
 *
 * @brief Unit test for TPAODV routing table
 */
 ...
 * @ingroup tpaodv-test
 *
 * @brief TPAODV test suite
 */
class AodvTestSuite : public TestSuite
{
  public:
    AodvTestSuite()
        : TestSuite("routing-tpaodv", Type::UNIT)
    {
...
} g_tpaodvTestSuite; ///< the test suite
