...
{
    static TypeId tid = TypeId("ns3::tpaodv::TypeHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
{
    static TypeId tid = TypeId("ns3::tpaodv::RreqHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
{
    static TypeId tid = TypeId("ns3::tpaodv::RrepHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
{
    static TypeId tid = TypeId("ns3::tpaodv::RrepAckHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
{
    static TypeId tid = TypeId("ns3::tpaodv::RerrHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
