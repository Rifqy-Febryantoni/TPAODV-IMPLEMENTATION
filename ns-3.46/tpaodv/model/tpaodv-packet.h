 ...
 */
#ifndef TPAODVPACKET_H
#define TPAODVPACKET_H
...
enum MessageType
{
    TPAODVTYPE_RREQ = 1,    //!< TPAODVTYPE_RREQ
    TPAODVTYPE_RREP = 2,    //!< TPAODVTYPE_RREP
    TPAODVTYPE_RERR = 3,    //!< TPAODVTYPE_RERR
    TPAODVTYPE_RREP_ACK = 4 //!< TPAODVTYPE_RREP_ACK
};
...
class TypeHeader : public Header
{
  public:
    /**
     * constructor
     * @param t the TPAODV RREQ type
     */
    TypeHeader(MessageType t = TPAODVTYPE_RREQ);
